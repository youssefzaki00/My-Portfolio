...
open_button.onclick = () => {
  ...
  open_after.style.right = '-45px';
  open_after.style.bottom = '-25px';
  open_before.style.left = '-45px';
  open_before.style.top = '-25px';
  if (open_click.classList.contains('close')) {
    ...
    open_after.style.right = '-60px';
    open_after.style.bottom = '-35px';
    open_before.style.left = '-50px';
    open_before.style.top = '-35px';
  }
}
...
projectDetails()
  open_project.style.top = '5%';
  open_project_after.style.right = '-45px';
  open_project_after.style.bottom = '-25px';
  open_project_before.style.left = '-45px';
  open_project_before.style.top = '-25px';
  if (open_project_click.classList.contains('close')) {
    ...
    open_project_after.style.right = '-60px';
    open_project_after.style.bottom = '-35px';
    open_project_before.style.left = '-50px';
    open_project_before.style.top = '-35px';
  }
})
